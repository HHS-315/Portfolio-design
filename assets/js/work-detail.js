...
(function () {
  ...
  var WORK_DETAILS = {
    ...
    "stac": {
      ...
      lead: "STAC은 혼자 기록하는 기존의 집중 타이머에서 벗어나, 전 세계 사용자와 함께 집중 시간을 쌓아가는 서비스입니다. 사용자가 집중한 시간만큼 브릭이 쌓이고, 모두의 브릭이 모일수록 문명이 단계적으로 발전합니다. 개인의 작은 집중이 하나의 거대한 세계를 만들어가는 경험을 통해 집중에 지속적인 동기를 부여합니다.",
