...
(function () {
  ...
  var WORK_DETAILS = {
    ...
    "maritime": {
      en: "Maritime Institute", title: "해양수산정책기술연구소", sub: "연구기관의 전문성과 신뢰를\n명확한 정보와 시각적 경험으로 전달하는 웹사이트",
      lead: "해양수산 분야의 전문성과 연구기관의 신뢰도를 직관적으로 전달할 수 있도록 해양수산정책기술연구소의 웹사이트를 디자인했습니다. 기관의 정보 전달 구조를 명확하게 정리하는 동시에, 이미지와 그래픽 요소를 적극적으로 활용해 일반적인 연구기관 웹사이트의 정적인 인상에서 벗어난 시각적 경험을 구축했습니다.",
