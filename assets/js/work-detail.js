  ...
  var WORK_DETAILS = {
    ...
    "stac": {
      ...
      rows: [   // 이미지는 실제 파일 없어 플레이스홀더(교체 시 IMG["stac-rowN"] 또는 vid)
        { h: "캐릭터 디자인", cap: "Z세대가 친근하게 받아들일 수 있는 캐릭터를 중심으로 STAC의 캐릭터를 제작했습니다. AI 이미지 생성 과정에서 형태와 표정, 컬러를 기획자와 의견을 나누며 문명의 발전을 이끌어나가는 캐릭터를 나노바나나를 사용하여 제작했습니다." },
        ...
        { h: "움직이는 세계", cap: "정적인 그래픽에 머무르지 않고, Kling을 활용해 캐릭터와 문명에 움직임을 더했습니다. 캐릭터의 행동과 환경의 변화를 자연스럽게 연결해, 사용자가 자신의 집중으로 실제로 성장하고 있다는 감각을 느낄 수 있도록 모션 그래픽으로 확장했습니다." },
        { h: "UI 그래픽 제작", cap: "서비스 내 다양한 기능과 정보를 시각적으로 전달하기 위해 Nano Banana를 활용해 UI 아이콘과 그래픽 에셋을 제작했습니다. 캐릭터와 문명에서 제작한 형태와 질감, 분위기를 아이콘에도 일관되게 반영해, 작은 UI 요소에서도 STAC의 비주얼 컨셉이 자연스럽게 이어지도록 구성했습니다." }
      ],
