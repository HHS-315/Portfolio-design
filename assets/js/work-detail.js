  ...
  var WORK_DETAILS = {
    ...
    "maritime": {
      ...
      rows: [
        ...
        { h: "INFORMATION — 복잡한 정보를 명확하게", cap: "연혁과 조직도처럼 정보량이 많은 콘텐츠는 단순한 텍스트 나열에서 벗어나 정보 간의 관계와 구조가 한눈에 파악되도록 시각화했습니다. 연혁은 시간의 흐름을 따라 탐색할 수 있는 타임라인으로, 조직도는 각 조직의 관계를 중심으로 재구성해 정보 탐색의 부담을 줄였습니다." },
