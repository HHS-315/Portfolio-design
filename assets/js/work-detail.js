...
(function () {
  ...
  var WORK_DETAILS = {
    ...
    "maritime": {
      ...
      outro: "기관의 신뢰성과 전문성을 유지하면서, 정보 중심의 연구기관 웹사이트에 보다 선명한 시각적 정체성을 더했습니다.\n콘텐츠의 성격에 따라 다양한 레이아웃을 적용하되 공통된 디자인 언어를 유지해, 연구소가 가진 정보와 방향성을 일관된 경험으로 전달할 수 있도록 완성했습니다.",
      stats: {
        h: "이번 프로젝트는.",
        items: [
          { v: "Tools", cap: "Photoshop" },
