...
(function () {
  ...
  var WORK_DETAILS = {
    ...
    "company-renewal": {
      ...
      rows: [
        { h: "기술의 시각화", cap: "AI 기반 앱 개발이라는 기업의 핵심 기술을 보다 직관적으로 전달하기 위해 실시간 협업, AI 기반 개발 프로세스, 모듈형 시스템을 중심으로 콘텐츠를 시각화했습니다. 각각의 기술적 특징을 핵심 메시지와 그래픽으로 연결해 복잡한 기술 정보를 쉽게 이해할 수 있도록 구성했습니다." },
        { h: "성과의 시각화", cap: "기업이 만들어온 성과와 성장 가능성을 효과적으로 전달하기 위해 주요 성과를 숫자 중심의 인포그래픽으로 구성했습니다. 핵심 데이터를 명확한 정보 위계로 배치하고 글로벌 이미지를 함께 활용해 기업의 규모와 성장성을 한눈에 파악할 수 있도록 표현했습니다." },
        { h: "기업 문화 소개", cap: "기술과 성과뿐만 아니라 회사가 추구하는 업무 환경과 조직 문화를 함께 전달할 수 있도록 구성했습니다. 사옥 인프라, 워케이션, 자율적인 업무 공간을 이미지와 함께 배치해 회사의 일하는 방식과 문화가 자연스럽게 드러나도록 표현했습니다." }
      ],
      stats: {   // TODO: Tools·Duration 실제 값으로 교체
        h: "이번 프로젝트는.",
        items: [
    ...
    "maritime": {
      ...
      rows: [
        ...
        { h: "하나의 흐름으로 연결된 화면", cap: "각 페이지마다 서로 다른 성격의 정보를 다루면서도 블루 컬러, 곡선형 그래픽, 타이포그래피와 여백 규칙을 일관되게 적용했습니다. 이를 통해 메인 비주얼부터 기관 소개, 연혁, 조직도, CI, 오시는 길까지 하나의 디자인 시스템 안에서 자연스럽게 연결되도록 구성했습니다." }
      ],
