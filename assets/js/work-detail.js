  ...
  var WORK_DETAILS = {
    ...
    "stac": {
      ...
      rows: [   // 이미지는 실제 파일 없어 플레이스홀더(교체 시 IMG["stac-rowN"] 또는 vid)
        ...
        { h: "문명의 발전", cap: "사용자의 집중이 쌓일수록 세계가 발전한다는 서비스 컨셉을 시각적으로 전달하기 위해 총 10단계의 문명 발전 과정을 제작했습니다. 각 문명의 단계에 할당된 브릭이 목표치에 도달하면 배경이 전환되며, 각 문명의 특징이 건축물과 환경에 자연스럽게 드러나도록 시각적 변화를 구성했습니다.", vid: "assets/video/stac_list1.mp4" },
