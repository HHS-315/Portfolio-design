 ...
 * fixed behind the ASCII dandelion (#field). Recoloured to dark-gray-on-black.
...
"}"
  ...
  // Dark-gray-on-black recolour (black base → deep grays). colorCount = 4.
  var UNIFORMS = {
    colors: [
      [0.000, 0.000, 0.000],
      [0.075, 0.075, 0.082],
    ...
    drift: 0.204,
    oklab: 0.0,
    timeScale: reduce ? 0.0 : 0.55   // frozen under reduced-motion, calm otherwise
  };
  ...
  gl.uniform4f(uni.cursor, 0, 0, 0, 1);   // cursor disabled: no pointer distortion

  var raf = 0, disposed = false;
  var visible = document.visibilityState === "visible";
  var inView = true;
  var start = performance.now();
  var animated = Math.abs(UNIFORMS.timeScale) > 0.0001;
  ...
  var onResize = function () { resizeCanvas(); requestRender(); };
